...
BEGIN_MESSAGE_MAP(CchameleonApp, CWinApp)
...
// 唯一的 CchameleonApp 对象

CchameleonApp theApp;


// CchameleonApp 初始化

BOOL CchameleonApp::InitInstance()
{
	// 启动方式：提权启动、加载驱动
